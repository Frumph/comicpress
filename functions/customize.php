...
class comicpress_Customize {
	...
	public static function register( $wp_customize ) {
		...
		$wp_customize->add_section( 'comicpress-scheme-options', array(
			'title'       => __( 'Layout Options', 'comicpress' ),
			'description' => __( 'Allows you to customize layout settings for ComicPress.', 'comicpress' ),
			'priority'    => 10,
		...
		$wp_customize->add_section( 'colors', array(
			'title'       => __( 'Background Colors', 'comicpress' ),
			'description' => __( 'Colors that are in the background of each of the sections.', 'comicpress' ),
			'priority'    => 20,
			'capability'  => 'edit_theme_options',
		) );

		$wp_customize->add_section( 'comicpress-text-colors', array(
			'title'      => __( 'Text Colors', 'comicpress' ),
			'priority'   => 30,
			'capability' => 'edit_theme_options',
		) );

		$wp_customize->add_section( 'comicpress-link-colors', array(
			'title'      => __( 'Link Colors', 'comicpress' ),
			'priority'   => 40,
			'capability' => 'edit_theme_options',
		) );

		$wp_customize->add_section( 'comicpress-logo-options', array(
			'title'      => __( 'Logo', 'comicpress' ),
			'priority'   => 50,
			'capability' => 'edit_theme_options',
		) );

		$wp_customize->add_setting( 'comicpress-customize-select-layout', array(
			'default'           => '3c',
			'type'              => 'theme_mod',
			'capability'        => 'edit_theme_options',
			'transport'         => 'refresh',
		...
		$wp_customize->add_setting( 'comicpress-customize-select-scheme', array(
			'default'           => 'none',
			'type'              => 'theme_mod',
			'capability'        => 'edit_theme_options',
			'transport'         => 'refresh',
		...
		$wp_customize->add_setting( 'comicpress-customize-range-site-width', array(
			'default'           => '980',
			'type'              => 'theme_mod',
			'capability'        => 'edit_theme_options',
			'transport'         => 'refresh',
		...
		$wp_customize->add_setting( 'comicpress-customize-range-left-sidebar-width', array(
			'default'           => '200',
			'type'              => 'theme_mod',
			'capability'        => 'edit_theme_options',
			'transport'         => 'refresh',
		...
		$wp_customize->add_setting( 'comicpress-customize-range-right-sidebar-width', array(
			'default'           => '200',
			'type'              => 'theme_mod',
			'capability'        => 'edit_theme_options',
			'transport'         => 'refresh',
		...
		$wp_customize->add_setting( 'comicpress-customize-detach-footer', array(
			'default'           => false,
			'type'              => 'theme_mod',
			'capability'        => 'edit_theme_options',
			'transport'         => 'refresh',
			'sanitize_callback' => 'comicpress_sanitize_checkbox',
		) );
		...
		$wp_customize->add_setting( 'comicpress-customize-checkbox-rounded', array(
			'default'           => false,
			'type'              => 'theme_mod',
			'capability'        => 'edit_theme_options',
			'transport'         => 'refresh',
		...
		$wp_customize->add_setting( 'comicpress-customize-checkbox-header-hotspot', array(
			'default'           => false,
			'type'              => 'theme_mod',
			'capability'        => 'edit_theme_options',
			'transport'         => 'refresh',
		...
		$wp_customize->add_setting( 'comicpress-customize[logo]', array(
			'default'           => '',
			'type'              => 'theme_mod',
			'capability'        => 'edit_theme_options',
			'transport'         => 'refresh',
		...
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'comicpress-customize-logo-image', array(
			'label'    => __( 'Logo, 120px height x 160px width', 'comicpress' ),
			'section'  => 'comicpress-logo-options',
			'settings' => 'comicpress-customize[logo]',
		) ) );

		if ( function_exists( 'ceo_pluginfo' ) ) {
			$wp_customize->add_setting( 'comicpress-customize-comic-in-column', array(
				'default'           => false,
				'type'              => 'theme_mod',
				'capability'        => 'edit_theme_options',
				'sanitize_callback' => 'comicpress_sanitize_checkbox',
		...
		$css_array = array(
			// Background Colors.
			array(
				'slug'        => 'page_background',
				'description' => '#page',
				'section'     => 'colors',
				'label'       => __( 'Entire Content Area', 'comicpress' ),
				'default'     => '',
			),
			array(
				...
				'description' => '#header',
				'section'     => 'colors',
				'label'       => __( 'Header', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'menubar_background',
				'description' => '#menubar-wrapper',
				'section'     => 'colors',
				'label'       => __( 'Menubar', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'menubar_submenu_background',
				'description' => '.menu ul li ul li a',
				'section'     => 'colors',
				'label'       => __( 'Menubar Dropdown', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'menubar_mouseover_background',
				'description' => '.menu ul li a:hover',
				'section'     => 'colors',
				'label'       => __( 'Menubar When Mouseover', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'breadcrumb_background',
				'description' => '#breadcrumb-wrapper',
				'section'     => 'colors',
				'label'       => __( 'Breadcrumbs', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'content_wrapper_background',
				'description' => '#content-wrapper',
				'section'     => 'colors',
				'label'       => __( 'Content Area Below Menubar', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'subcontent_wrapper_background',
				'description' => '#subcontent-wrapper',
				'section'     => 'colors',
				'label'       => __( 'Content Area Below Comic', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'narrowcolumn_widecolumn_background',
				'description' => '#content-column',
				'section'     => 'colors',
				'label'       => __( 'Content Column', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'post_page_navigation_background',
				'description' => '.uentry, #comment-wrapper, #wp-paginav, #pagenav',
				'section'     => 'colors',
				'label'       => __( 'Entire Post Area', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'post_info_background',
				'description' => '.post-info',
				'section'     => 'colors',
				'label'       => __( 'Top Section of a Post', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'comment_background',
				'description' => '.comment, #comment-wrapper #wp-paginav',
				'section'     => 'colors',
				'label'       => __( 'Comment Section', 'comicpress' ) ,
				'default'     => '',
			),
			array(
				'slug'        => 'comment_meta_data_background',
				'description' => '.comment-meta-data',
				'section'     => 'colors',
				'label'       => __( 'Comment Info. Line', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'bypostauthor_background',
				'description' => '.bypostauthor',
				'section'     => 'colors',
				'label'       => __( 'Comments Made By Post Author', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'bypostauthor_meta_data_background',
				'description' => '.bypostauthor .comment-meta-data',
				'section'     => 'colors',
				'label'       => __( 'Info. Line Of Post Author', 'comicpress' ),
				'default'     => '',
			),
			array(
			...
			array(
				...
				'description' => 'body',
				'section'     => 'comicpress-text-colors',
				'label'       => __( 'Sitewide Textcolor', 'comicpress' ),
				'default'     => '',
			),
			array(
			...
			array(
				'slug'        => 'header_description_textcolor',
				'description' => '.header-info .description',
				'section'     => 'comicpress-text-colors',
				'label'       => __( 'Site Description', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'breadcrumb_textcolor',
				'description' => '#breadcrumb-wrapper',
				'section'     => 'comicpress-text-colors',
				'label'       => __( 'Breadcrumbs', 'comicpress' ),
				'default'     => '',
			...
			array(
				'slug'        => 'lrsidebar_widgettitle_textcolor',
				'description' => 'h2.widget-title',
				'section'     => 'comicpress-text-colors',
				'label'       => __( 'Widget Titles', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'lrsidebar_textcolor',
				'description' => '.sidebar',
				'section'     => 'comicpress-text-colors',
				'label'       => __( 'Sidebar', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'posttitle_textcolor',
				'description' => 'h2.post-title',
				'section'     => 'comicpress-text-colors',
				'label'       => __( 'Non-Link Post Titles', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'pagetitle_textcolor',
				'description' => 'h2.page-title',
				'section'     => 'comicpress-text-colors',
				'label'       => __( 'Page Titles', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'postinfo_textcolor',
				'description' => '.post-info',
				'section'     => 'comicpress-text-colors',
				'label'       => __( 'Top Section of a Post', 'comicpress' ),
				'default'     => '',
			...
			array(
				'slug'        => 'post_page_navigation_textcolor',
				'description' => '.uentry, #comment-wrapper, #wp-paginav',
				'section'     => 'comicpress-text-colors',
				'label'       => __( 'Post/Page Comments', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'footer_textcolor',
				'description' => '#footer',
				'section'     => 'comicpress-text-colors',
				'label'       => __( 'Footer', 'comicpress' ),
				'default'     => '',
			...
			array(
				'slug'        => 'footer_copyright_textcolor',
				'description' => '.copyright-info',
				'section'     => 'comicpress-text-colors',
				'label'       => __( 'Copyright', 'comicpress' ),
				'default'     => '',
			),
			// Link Colors.
			array(
				'slug'        => 'content_link_acolor',
				'description' => 'body a:link',
				'section'     => 'comicpress-link-colors',
				'label'       => __( 'Sitewide Linkcolor', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'content_link_vcolor',
				'description' => 'body a:visited',
				'section'     => 'comicpress-link-colors',
				'label'       => '',
				'default'     => '',
			),
			array(
				'slug'        => 'content_link_hcolor',
			...
			array(
				'slug'        => 'header_title_acolor',
				'description' => '#header h1 a',
				'section'     => 'comicpress-link-colors',
				'label'       => __( 'Header', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'header_title_hcolor',
				'description' => '#header h1 a:hover',
				'section'     => 'comicpress-link-colors',
				'label'       => '',
				'default'     => '',
			),
			array(
				'slug'        => 'menubar_top_acolor',
				'description' => '.menu ul li a:link, .menu ul li a:visited, .mininav-prev a, .mininav-next a',
				'section'     => 'comicpress-link-colors',
				'label'       => __( 'Menubar', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'menubar_hcolor',
				'description' => '.menu ul li a:hover, .menu ul li a.selected, .menu ul li ul li a:hover, .menunav a:hover',
				'section'     => 'comicpress-link-colors',
				'label'       => '',
				'default'     => '',
			),
			array(
				'slug'        => 'menubar_sub_acolor',
				'description' => '.menu ul li ul li a:link, .menu ul li ul li a:visited',
				'section'     => 'comicpress-link-colors',
				'label'       => '',
				'default'     => '',
			),
			array(
				'slug'        => 'breadcrumb_acolor',
				'description' => '.breadcrumbs a',
				'section'     => 'comicpress-link-colors',
				'label'       => __( 'Breadcrumbs', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'breadcrumb_hcolor',
				'description' => '.breadcrumbs a:hover',
				'section'     => 'comicpress-link-colors',
				'label'       => '',
				'default'     => '',
			),
			array(
				'slug'        => 'sidebar_acolor',
				'description' => '.sidebar .widget a',
				'section'     => 'comicpress-link-colors',
				'label'       => __( 'Sidebar Widget', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'sidebar_hcolor',
				'description' => '.sidebar .widget a:hover',
				'section'     => 'comicpress-link-colors',
				'label'       => '',
				'default'     => '',
			),
			array(
				'slug'        => 'postpagenav_acolor',
				'description' => '.entry a, .blognav a, #paginav a, #pagenav a',
				'section'     => 'comicpress-link-colors',
				'label'       => '',
				'default'     => '',
			),
			array(
				'slug'        => 'postpagenav_hcolor',
				'description' => '.entry a:hover, .blognav a:hover, #paginav a:hover, #pagenav a:hover',
				'section'     => 'comicpress-link-colors',
				'label'       => '',
				'default'     => '',
			),
			...
			array(
				'slug'        => 'footer_copyright_acolor',
				'description' => '.copyright-info a',
				'section'     => 'comicpress-link-colors',
				'label'       => __( 'Copyright', 'comicpress' ),
				'default'     => '',
			),
			array(
				'slug'        => 'footer_copyright_hcolor',
				'description' => '.copyright-info a:hover',
				'section'     => 'comicpress-link-colors',
				'label'       => '',
				'default'     => '',
			),
		...
		if ( function_exists( 'ceo_pluginfo' ) ) {
			$css_array[] = array(
				'slug'        => 'comic_wrap_background',
				'description' => '#comic-wrap',
				'section'     => 'colors',
				'label'       => __( 'Comic Area', 'comicpress' ),
				'default'     => '',
			);
			$css_array[] = array(
				'slug'        => 'comic_wrap_textcolor',
				'description' => '#comic-wrap',
				'section'     => 'comicpress-text-colors',
				'label'       => '',
				'default'     => '',
			...
			$css_array[] = array(
				'slug'        => 'comic_nav_background',
				'description' => 'table#comic-nav-wrapper',
				'section'     => 'colors',
				'label'       => __( 'Default Comic Navigation', 'comicpress' ),
				'default'     => '',
			);
			$css_array[] = array(
				'slug'        => 'comic_nav_textcolor',
				'description' => '.comic-nav',
				'section'     => 'comicpress-text-colors',
				'label'       => __( 'Default Nav Normal Text Color', 'comicpress' ),
				'default'     => '',
			);
			$css_array[] = array(
				'slug'        => 'comic_nav_acolor',
				'description' => '.comic-nav a:link, .comic-nav a:visited',
				'section'     => 'comicpress-link-colors',
				'label'       => __( 'Default Navigation Link', 'comicpress' ),
				'default'     => '',
			);
			$css_array[] = array(
				'slug'        => 'comic_nav_hcolor',
				'description' => '.comic-nav a:hover',
				'section'     => 'comicpress-link-colors',
				'label'       => __( 'Default Navigation Hover', 'comicpress' ),
				'default'     => '',
			);
		}
		...
		foreach ( $css_array as $setinfo ) {
			...
			$wp_customize->add_setting( $setinfo_register_name, array(
				'default'           => $default,
				'type'              => 'theme_mod',
				'capability'        => 'edit_theme_options',
				'transport'         => 'refresh',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					$setinfo['slug'], array(
						...
						'section'     => $setinfo['section'],
						'settings'    => $setinfo_register_name,
	...
	public static function header_output() {
		...
		$settings_array = array(
			...
			array(
				'slug'      => 'menubar_mouseover_background',
				'element'   => '.menu ul li a:hover, .menu ul li a.selected',
				'style'     => 'background-color',
				'default'   => '',
				'important' => true,
			),
			...
			array(
				'slug'      => 'narrowcolumn_widecolumn_background',
				'element'   => '.narrowcolumn, .widecolumn',
				'style'     => 'background-color',
				'default'   => '',
				'important' => true,
			),
			array(
				'slug'      => 'post_page_navigation_background',
				'element'   => '.uentry, #comment-wrapper, #wp-paginav, .blognav, #pagenav',
				'style'     => 'background-color',
				'default'   => '',
				'important' => true,
			),
			...
			array(
				'slug'      => 'comment_background',
				'element'   => '.comment, #comment-wrapper #wp-paginav',
				'style'     => 'background-color',
				'default'   => '',
				'important' => true,
			),
			...
			array(
				'slug'      => 'bypostauthor_meta_data_background',
				'element'   => '.bypostauthor .comment-meta-data',
				'style'     => 'background-color',
				'default'   => '',
				'important' => true,
			),
			...
			array(
				'slug'      => 'post_page_navigation_textcolor',
				'element'   => '.uentry, #comment-wrapper, #wp-paginav',
				'style'     => 'color',
				'default'   => '',
				'important' => true,
			),
			...
			array(
				'slug'      => 'header_title_acolor',
				'element'   => '#header h1 a:link, #header h1 a:visited',
				'style'     => 'color',
				'default'   => '',
				'important' => true,
			),
			...
			array(
				'slug'      => 'menubar_top_acolor',
				'element'   => '.menu ul li a:link, .menu ul li a:visited, .mininav-prev a, .mininav-next a, a.menunav-rss',
				'style'     => 'color',
				'default'   => '',
				'important' => true,
			),
			array(
				'slug'      => 'menubar_hcolor',
				'element'   => '.menu ul li a:hover, .menu ul li a.selected, .menu ul li ul li a:hover, .menunav a:hover, a.menunav-rss:hover',
				'style'     => 'color',
				'default'   => '',
				'important' => true,
			),
			array(
				'slug'      => 'menubar_sub_acolor',
				'element'   => '.menu ul li ul li a:link, .menu ul li ul li a:visited',
				'style'     => 'color',
				'default'   => '',
				'important' => true,
			),
			...
			array(
				'slug'      => 'postpagenav_acolor',
				'element'   => '.entry a, .blognav a, #paginav a, #pagenav a',
				'style'     => 'color',
				'default'   => '',
				'important' => true,
			),
			array(
				'slug'      => 'postpagenav_hcolor',
				'element'   => '.entry a:hover, .blognav a:hover, #paginav a:hover, #pagenav a:hover',
				'style'     => 'color',
				'default'   => '',
				'important' => true,
			),
			...
			array(
				'slug'      => 'footer_copyright_hcolor',
				'element'   => '.copyright-info a:hover, .blognav a:hover, #paginav a:hover',
				'style'     => 'color',
				'default'   => '',
				'important' => true,
			),
		...
		if ( function_exists( 'ceo_pluginfo' ) ) {
			...
			$settings_array[] = array(
				'slug'      => 'comic_nav_background',
				'element'   => 'table#comic-nav-wrapper',
				'style'     => 'background-color',
				'default'   => '',
				'important' => true,
			);
			...
			$settings_array[] = array(
				'slug'      => 'comic_nav_acolor',
				'element'   => '.comic-nav a:link, .comic-nav a:visited',
				'style'     => 'color',
				'default'   => '#FFFFFF',
				'important' => true,
			);
...
<style type="text/css">
		...
		\r\n";
			...
			if ( ( $scheme == 'sandy' ) || ( $scheme == 'high' ) )
			$style_output .= "\t#page, #page-wide {
				width: " . $comic_width . "px!important;
				max-width: 100%!important;
			}\r\n";

			$style_output .= "\t#header, #menubar-wrapper, #breadcrumb-wrapper, #subcontent-wrapper, #footer, #footer-sidebar-wrapper {
				width: " . $page_width . "px;
				max-width: " . $page_width . "px;
			}
			\r\n";

			$style_output .= "\t#comic-wrap {
				max-width: 100%;
			}
			\r\n";
		}
		...
		$style_output .= "\t#add-width {
			width: " . $add_width . "px;
		}
		\r\n";

		$style_output .= "\t#content-column {
		...
		$style_output .= "\t#sidebar-right {
			width: " . $right_sidebar_width . "px;
			}
			\r\n";

		$style_output .= "\t#sidebar-left {
		...
		if ( isset( $customize['logo'] ) && ! empty( $customize['logo'] ) ) {
			...
			$style_output .= "\t.header-info h1 {
				margin: 0;
				padding: 0;
				background: url(\"" . $customize['logo'] . "\") top left no-repeat;
				background-size: contain;
				display: cover;
			}
			\r\n";

			$style_output .= "\t.header-info h1 a {
				padding: 0;
				margin: 0;
				height: 120px;
				width: 180px;
			...
			$style_output .= "\t.header-info .description {
