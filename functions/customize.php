...
//	$wp_customize->add_section('comicpress-background-colors' , array('title' => __('Background Colors','comicpress')));
	...
	$css_array = array(
			...
			array('slug' => 'footer_textcolor', 'description' => '#footer', 'section' => 'comicpress-text-colors', 'label' => 'Footer'),
...
function comicpress_customize_wp_head() {
	...
	$settings_array = array(
			...
			array('slug' => 'subcontent_wrapper_background', 'element' => '#subcontent-wrapper', 'style' => 'background-color', 'default' => '#FFFFFF',  'important' => false),
