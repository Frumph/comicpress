...
/*	
		...
		$wp_customize->add_control( 
			new WP_Customize_Image_Control( $wp_customize, 'comicpress-customize-logo-image', 
				array(
...
*/
		...
		$css_array = array(
			...
			array('slug' => 'menubar_background', 'description' => '#menubar-wrapper', 'section' => 'colors', 'label' => __( 'Menubar', 'comicpress' ), 'default' => '#000000'),
			...
			array('slug' => 'menubar_hcolor', 'description' => '.menu ul li a:hover, .menu ul li a.selected, .menu ul li ul li a:hover', 'section' => 'comicpress-link-colors', 'label' => '', 'default' => ''),
	...
	public static function header_output() {
		...
		$settings_array = array(
			...
			array('slug' => 'content_wrapper_background', 'element' => '#content-wrapper', 'style' => 'background-color', 'default' => '#ffffff',  'important' => false),
