...
if ( ! function_exists( 'comicpress_register_sidebars' ) ) {
	...
	function comicpress_register_sidebars() {
		...
		$widgets_list = array(
			array(
				'id'          => 'left-sidebar',
				'name'        => __( 'Left Sidebar', 'comicpress' ),
				'description' => __( 'The sidebar that appears to the left of the content.', 'comicpress' ),
			),
			array(
				'id'          => 'right-sidebar',
				'name'        => __( 'Right Sidebar', 'comicpress' ),
				'description' => __( 'The sidebar that appears to the right of the content.', 'comicpress' ),
			),
			array(
				'id'          => 'above-header',
			...
			array(
				'id'          => 'header',
				'name'        => __( 'Header', 'comicpress' ),
				'description' => __( 'This sidebar appears inside the #header block.', 'comicpress' ),
			),
			array(
				'id'          => 'menubar',
				'name'        => __( 'Menubar', 'comicpress' ),
				'description' => __( 'This sidebar is under the header and above the content-wrapper block', 'comicpress' ),
			),
			array(
				'id'          => 'over-blog',
			...
			array(
				'id'          => 'footer',
				'name'        => __( 'Footer', 'comicpress' ),
				'description' => __( 'This sidebar is at the bottom of the page and is the center of the 3 footer sidebars.', 'comicpress' ),
			),
			array(
				'id'          => 'footer-left',
				'name'        => __( 'Footer Left', 'comicpress' ),
				'description' => __( 'This sidebar is at the bottom of the page, the left one.', 'comicpress' ),
			),
			array(
				'id'          => 'footer-right',
				'name'        => __( 'Footer Right', 'comicpress' ),
				'description' => __( 'This sidebar is at the bottom of the page, the right one.', 'comicpress' ),
			),
		);
		if ( class_exists( 'Jetpack' ) && Jetpack::init()->is_module_active( 'minileven' ) ) {
			$widgets_list[] = array(
				'id'          => '1',
				'name'        => __( 'Jetpack Mobile Sidebar', 'comicpress' ),
				'description' => __( 'Jetpack Mobile Sidebar', 'comicpress' ),
			);
		}
