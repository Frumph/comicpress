...
function comicpress_random_post() {
	...
	$randomPostQuery = new WP_Query();
	$randomPostQuery->query( 'showposts=1&orderby=rand' );
	$random_post_id = '';
...
class comicpress_random_post_link_widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			array(
				'classname'   => __CLASS__,
				'description' => __( 'Displays a link to click that triggers going to a random blog post.', 'comicpress' ), // Args.
			)
		);
	}
