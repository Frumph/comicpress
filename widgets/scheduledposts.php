...
class comicpress_scheduled_posts_widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			array(
				'classname'   => __CLASS__,
				'description' => __( 'Display a list of posts that are scheduled to be published.', 'comicpress' ), // Args.
			)
		);
	}
	...
	public function widget( $args, $instance) {
		...
		if ( empty( $scheduled_posts ) ) {
			...
			foreach ( $scheduled_posts as $post ) :
				?>
				<li>
					<span class="scheduled-post-date">
					...
					<span class="scheduled-post-title">
