		...
		<div class="easel-options">
			...
			<table class="widefat">
				...
				<tr class="alternate">
					...
					<td>
						<?php _e('Width:','comicpress'); ?> <input type="text" size="5" name="custom_image_header_width" id="custom_image_header_width" value="<?php echo $easel_options['custom_image_header_width']; ?>" />px &nbsp;
						<?php _e('Height:','comicpress'); ?> <input type="text" size="5" name="custom_image_header_height" id="custom_image_header_height" value="<?php echo $easel_options['custom_image_header_height']; ?>" />px<br />
						...
						<strong><?php _e('NOTE: This is no longer necessary since Easel 3.1.1, flexible headers will determine your height and width of your image, the available space per layout for width still applies.', 'comicpress'); ?></strong>
					</td>
				</tr>
			</table>
			...
			<table class="widefat">
				...
				<tr>
					...
					<td>
						<?php _e('When setting this option, Easel will add meta information to the head area of each page so that facebook will recognize the content within.','comicpress'); ?>
					</td>
				</tr>
			</table>
